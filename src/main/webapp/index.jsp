...
<div>
    <h1>百度UEditor    </h1>
    <a href="http://my.oschina.net/u/140593/blog" target="_blank">获得源代码 请站内留言</a>
    <form action="/save.do" method="post" name="form">
...
<script type="text/javascript">
    ...
    function submitform(){
        document.form.message.value=UE.getEditor('editor').getContent();
